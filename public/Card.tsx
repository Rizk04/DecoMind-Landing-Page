...
const Card = ({ title, description, Icon }: Props) => {
  return (
    <div
      className="flex flex-col items-center justify-center bg-white shadow-sm rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 text-center w-full md:w-64 lg:w-72"
      style={{
