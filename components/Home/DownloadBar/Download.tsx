...
const Download = () => {
  return (
    <div className="flex justify-center px-4 py-20 md:py-40 bg-gray-100">
      <motion.div
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 w-full px-6 md:px-12 py-10 md:py-16">
